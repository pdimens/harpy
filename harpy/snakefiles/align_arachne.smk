...
rule process_reference:
    ...
    output: 
        ...
        bwa_idx = multiext(workflow_geno, ".fai", ".gzi", '.amb', '.ann', '.bwt', '.pac', '.sa'),
...
rule arachne_align:
    input:
        ...
        R2 = "arachne/prep/{sample}.arachne.R1.fq.gz",
    ...
    shell:
        ...
        arachne align -t {threads} {params} {input.ref} {input.fastq} > {output} 2> {log}
        """

#TODO add bwa for invalids
