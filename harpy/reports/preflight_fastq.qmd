...
| :--------------- | :---------------------------------------------------------------------------- | :--------------------------------------------------------- |
| **AxxCxxBxxDxx** | **all** reads with `BX:Z` tag have properly formatted `AxxCxxBxxDxx` barcodes | **any** BX:Z barcodes have incorrect format                |
...
These columns are defined below and the severities of their issues will be given as colored emoji:
