...
list(
  color = "#dfdfdf",
  value = scales::label_comma(ndel, accuracy = 0.01)
)
```
```{r}
#| content: valuebox
...
list(
  color = "#dfdfdf",
  value = scales::label_comma(ndup, accuracy = 0.01)
)
```
```{r}
#| content: valuebox
...
list(
  color = "#dfdfdf",
  value = scales::label_comma(ninv, accuracy = 0.01)
)
```
