...
- `molecules` are the unique DNA molecules as inferred from linked-read barcodes
  ...
  - `nonsingletons` refer to molecules composed of more than two single-end or paired-end sequences
...
```{r perc_valid_per_sample, fig.height=figheight, out.width="100%"}
...
### nonsingletons percent {.no-title}
```{r perc_nonsingleton, fig.height=figheight, out.width="100%"}
hchart(aggregate_df, "xrange", animation = F, groupPadding = 0.0001,
...
```{r reads_per_mol_sample, fig.height=figheight, out.width="100%"}
...
```{r avg_mol_cov, fig.height=figheight, out.width="100%"}
