...
file <- snakemake@input$blockfile
df <- read.table(
  file, header = T,
...
### N50
```{r}
valueBox(scales::comma(overall$N50[1]), caption = "N50", color = "info")
```

### N75
```{r}
valueBox(scales::comma(overall$N75[1]), caption = "N75", color = "info")
```

### N90
```{r}
valueBox(scales::comma(overall$N90[1]), caption = "N90", color = "info")
```
