...
list(
  color = "info",
  value = scales::label_comma(params$bxlimit)
)
```
...
list(
  color = "light",
  value = scales::label_comma(sn$samples[1])
)
```
...
list(
  color = "#dfdfdf",
  value = scales::label_comma(sn$records[1])
)
```
...
list(
  color = "#dfdfdf",
  value = scales::label_comma(sn[3,1])
)
```
...
list(
  color = "#dfdfdf",
  value = scales::label_comma(sn$SNPs[1])
)
```
...
list(
  color = "#dfdfdf",
  value = scales::label_comma(sn$MNPs[1])
)
```
