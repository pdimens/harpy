---
title: "STITCH Imputation - "`r gsub(".stats$", "", params$statsfile)`"
params:
  plotdir: 'plots/'
...
list(
  color = "info",
  value = format(bxlimit, scientific = F)
)
```
