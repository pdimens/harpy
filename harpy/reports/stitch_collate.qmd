...
list(
  color = "info",
  value = scales::comma(params$bxlimit)
)
```
...
list(
  color = "light",
  value = scales::comma(sn$samples[1])
)
```
...
list(
  color = "#dfdfdf",
  value = scales::comma(sn$records[1])
)
```
