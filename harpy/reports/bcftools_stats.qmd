...
list(
  color = "light",
  value = scales::label_comma(sn[1,1])
)
```
```{r}
#| content: valuebox
...
list(
  color = "#dfdfdf",
  value = scales::label_comma(sn[1,2])
)
```
```{r}
#| content: valuebox
...
list(
  color = "#dfdfdf",
  value = scales::label_comma(sn[1,4])
)
```
```{r}
#| content: valuebox
...
list(
  color = "#dfdfdf",
  value = scales::label_comma(sn[1,5])
)
```
```{r}
#| content: valuebox
...
list(
  color = "#dfdfdf",
  value = scales::label_comma(sn[1,6])
)
```
```{r}
#| content: valuebox
...
list(
  color = "#dfdfdf",
  value = scales::label_comma(sn[1,8])
)
```
```{r}
#| content: valuebox
...
list(
  color = "#dfdfdf",
  value = scales::label_comma(sn[1,9])
)
```
```{r}
#| content: valuebox
...
list(
  color = "#dfdfdf",
  value = scales::label_comma(sn[1,3])
)
```
```{r}
#| content: valuebox
...
list(
  color = "#dfdfdf",
  value = scales::label_comma(sn[1,7])
)
```
