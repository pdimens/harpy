...
colnames(tmbol) <- c("contig", "position", "mol_depth")
...
hchart(hs, "areaspline", hcaes(x = val, y = freq), color = "#9393d2", name = "% intervals (alignments)", marker = list(enabled = FALSE)) |>
  hc_add_series(data = mol_hs, type = "areaspline", hcaes(x = val, y = freq), name = "% intervals (molecules)")
