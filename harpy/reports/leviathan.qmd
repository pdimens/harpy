...
```
##
This circular plot visualizes the distribution of structural variants
across (up to) 30 of the largest contigs, unless specific contigs were provided.
The legend shows which colors correspond to which type of variant. To save the plot,
you will need to take a screenshot. Note that it may be difficult to see very small variants.
