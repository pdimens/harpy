...
list(
  color = "light",
  value = scales::comma(round(mean(aggregate_df$N50[aggregate_df$N50 != 0]), 0))
)
```
...
list(
  color = "light",
  value = scales::comma(round(mean(aggregate_df$N75[aggregate_df$N75 != 0]), 0))
)
```
...
list(
  color = "light",
  value = scales::comma(round(mean(aggregate_df$N90[aggregate_df$N90 != 0]), 0))
)
```
