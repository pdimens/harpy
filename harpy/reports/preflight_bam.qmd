...
| :--------------- | :--------------------------------------------------------------------------------- | :-------------------------------------------------------- |
| **Name Match**   | the file name matches the `@RG ID:` tag in the header                              | file name does not match `@RG ID:` in the header          |
...
datatable(
  ...
  fillContainer = T,
  colnames = c("File", "Reads", "Name Match", "MI tag", "BX:Z tag", "BX:Z last", "AxxCxxBxxDxx")
) %>%
formatStyle(
  columns = 3:ncol(data),
