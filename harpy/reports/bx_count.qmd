...
# Overview
##
<h2> General Per-Sample Haplotag Barcode Statistics </h2>
...
list(
  icon = "files",
  color = "light",
  value = scales::comma(nrow(BXstats))
)
```
...
column_description <- c(
  ...
  "number of valid haplotag barcodes",
  "percent of haplotag barcodes that are valid",
  "number of invalid haplotag barcodes, i.e. with a 00 segment",
  "percent of haplotag barcodes that are invalid"
  )
...
These three visualizations show the occurrence of invalid haplotag barcodes.
