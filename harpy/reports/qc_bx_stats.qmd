---
title: "QC Linked-Read Bardcode Summary"
params:
  indir: 'logs/bxcount'
---
...
uppercase nucleotides (`A`, `T`, `C`, `G`, `N`), with `0` being considered invalid. TELLseq
...
for (j in seq_along(infiles)) {
  ...
  if(j == 1){
      ...
      .invalid <- t(rbind(c("Sample", samplename), c("TotalBarcodes", total),s_df[5:nrow(s_df),]))
...
Below is information describing linked-read barcord invalidations across all **forward reads**
