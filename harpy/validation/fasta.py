...
class FASTA():
    ...
    def __init__(self, fasta, quiet:bool = False):
        ...
        self.print.log("Validating input FASTA file format")
    ...
    def match_contigs(self, contigs: str):
        ...
        self.print.log("Validating input contigs against those in the input FASTA")
        valid_contigs = []
    ...
    def validate_region(self, regioninput) -> None:
        ...
        self.print.log("Validating input regions to those in the input FASTA")
