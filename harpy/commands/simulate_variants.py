...
@click.option_panel("Known Variants", options = ["--indel-vcf", "--snp-vcf"])
@click.option_panel("Random Variants",
    options = sorted(["--centromeres", "--exclude-chr", "--genes", "--indel-count", "--indel-ratio", "--snp-count", "--snp-gene-constraints", "--titv-ratio"])
)
@click.option_panel("Heterozygosity", options = OPT_HET)
@click.option_panel("Workflow Options", options =OPT_WORKFLOW)
...
@click.option_panel("Known Variants", options = ["--vcf"])
@click.option_panel("Random Variants",
