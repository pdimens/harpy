...
def bam(inputs, output_dir, threads, snakemake, quiet, hpc, clean, container, setup_only):
    """
...
def fastq(inputs, output_dir, threads, snakemake, quiet, hpc, clean, container, setup_only):
    """
