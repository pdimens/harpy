...
- snakefiles have harpy version at the top, along with a comment of what harpy version it was generated by
...
- the `--workflow-profile` part of the snakemake command (when using hpc) has been moved to `profile.yaml` to further reduce the length of the snakemake call
