...
description: Helpful things to understand about Snakemake
icon: git-merge
---
...
all sorts of things necessary for Snakemake to do its magic, but most of what you
might be interested in is `.snakemake/logs`.
