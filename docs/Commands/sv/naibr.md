...
- sequence alignments: [!badge variant="success" text=".bam"] [!badge variant="secondary" icon=":exclamation:" text="coordinate-sorted"] [!badge variant="secondary" icon=":exclamation:" text="phased"]
...
[Barcode Thresholds](https://blinkseq.github.io/linkedreads/clashing/#barcode-thresholds) for more information on what this value does. If you want
