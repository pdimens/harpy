...
- paired-end fastq sequence files [!badge variant="secondary" icon=":heart:" icon=":heart:" text="gzipped recommended"]
...
- slower
- marks split alignments as secondary alignments [⚠️](/Commands/SV/leviathan.md)
