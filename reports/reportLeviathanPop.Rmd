...
circosplot <- function(data, contigdata, svtype, trackheight, poplist){
  circos.clear()
  col_text <- "grey40"
...
for (SV in c("INV", "DEL", "DUP", "BND")){
  circosplot(sv, fa.sizes, SV, popheight, populations)
}
lgd <- Legend(
    at = populations,
    type = "grid",
...
draw(lgd, x = unit(0, "npc"), just = c("right", "bottom"))
