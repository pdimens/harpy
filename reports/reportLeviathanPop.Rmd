...
```{r echo = FALSE, message = FALSE, warning = FALSE, fig.align='center', fig.height=2, out.width= "100%"}
...
legend("topleft", legend = populations, pch=15, pt.cex=1, cex=1, bty='n',
    col = col.ramp, ncol=6)
mtext("Populations", at=0.2, cex=1.5)
```
