...
alignment depth of the barcoded sequences, and the reddish color showing alignment depth of sequences
...
cov.yaxis <- c(round(min(.gencov$noBarcode), digits = -1), 0, round(maxaln * 1/3, digits = -1), round(maxaln * 2/3, digits = -1), maxaln)
# coverage
circos.genomicTrack(
  data=.gencov, 
