...
author:
    - "`r gsub('.bxstats.gz', '', 'file.bxstats.gz')`"
...
as unique molecules when their distance is greater than `r mdist` base pairs.
...
the barcodes in your alignment file **were not** altered.
