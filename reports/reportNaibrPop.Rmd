...
DT::datatable(genstats, rownames = F, filter = "top", extensions = 'Buttons', options = list(dom = 'Brtip', buttons = c('csv'), scrollX = TRUE), colnames = c("Population", "Deletion Count", "Deletion Average", "Deletion Stdv", "Duplication Count", "Duplication Average", "Duplication Stdv", "Inversion Count", "Inversion Average", "Inversion Stdv"))
```
...
DT::datatable(sv_clean, rownames = F, filter = "top", extensions = 'Buttons', options = list(dom = 'Brtip', buttons = c('csv'), scrollX = TRUE))
```
### chimeric variants
...
```{r echo = FALSE, warnings = FALSE, message = FALSE}
DT::datatable(chimeric(sv), rownames = F, filter = "top", extensions = 'Buttons', options = list(dom = 'Brtip', buttons = c('csv'), scrollX = TRUE))
