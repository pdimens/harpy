...
#  c("/home/pdimens/ZS10.ema.bedpe", "/home/pdimens/ZS10.bwa.bedpe")
...
variants between populations. To the right is the legend to these plots, where
...
ggplot(aes(x, y, fill = colour))+
  ...
  guides(fill = guide_legend(title.position = "top", title.hjust = 0.5, override.aes = list(alpha=1, size = 13)))+ # showing the point in the legend
  theme_void() +
