...
circos.genomicTrack(
  ...
  panel.fun=function(region, value, ...) {
    circos.genomicRect(region, value, ybottom = 0, ytop = 1, col = "#1E88E5")
  }
)
...
circos.genomicTrack(
  ...
  bg.border = F,
  panel.fun=function(region, value, ...) {
    circos.genomicRect(region, value, ybottom = 0, ytop = 1, col = "#004D40")
  }
)
...
circos.genomicTrack(
  ...
  bg.border = F,
  panel.fun=function(region, value, ...) {
    circos.genomicRect(region, value, ybottom = 0, ytop = 1, col = "#FFC107")
  }
)
...
circos.genomicTrack(
  ...
  bg.border = F,
  panel.fun=function(region, value, ...) {
    circos.genomicRect(region, value, ybottom = 0, ytop = 1, col = "#D81B60")
  }
)
