...
circos.genomicTrack(
  ...
  panel.fun=function(region, value, ...) {
    circos.genomicRect(region, value, ybottom = 0, ytop = 1, col = "#1E88E5", border = "#1E88E5", alpha = 0.8)
  }
)
...
circos.genomicTrack(
  ...
  bg.border = F,
  panel.fun=function(region, value, ...) {
    circos.genomicRect(region, value, ybottom = 0, ytop = 1, col = "#004D40", border = "#004D40", alpha = 0.8)
  }
)
...
circos.genomicTrack(
  ...
  bg.border = F,
  panel.fun=function(region, value, ...) {
    circos.genomicRect(region, value, ybottom = 0, ytop = 1, col = "#FFC107", border =  "#FFC107", alpha = 0.8)
  }
)
...
circos.genomicTrack(
  ...
  bg.border = F,
  panel.fun=function(region, value, ...) {
    circos.genomicRect(region, value, ybottom = 0, ytop = 1, col = "#D81B60", border = "#D81B60", alpha = 0.8)
  }
)
