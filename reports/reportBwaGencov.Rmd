...
and depth for the file `r paste0(sname, ".bam")`.
...
### glob-sd
```{r}
valueBox(scales::comma(global_sd), caption = "Depth standard deviation", color = "info")
```
...
### filt-sd
```{r}
valueBox(scales::comma(global_sd_filt), caption = "Depth standard deviation (filtered)", color = "info")
```
