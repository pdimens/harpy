...
maxaln <- round(max(.gencov$depth), digits = -1)
...
circos.genomicTrack(
  ...
  panel.fun = function(region, value, ...) {
    ...
    circos.segments(x0=0, x1=max(.contigs$size), y0=min(.gencov$depth)-100, y1=min(.gencov$depth) - 100, lwd=0.8, lty="11", col="grey90")
...
Note that both the X and Y axes vary between all contigs.
