...
for (i in snakemake@input[["countlog"]]) {
  ...
  BXstats <- rbind(BXstats, data.frame(Sample = samplename, ReadsIgnored = ignored, BarcodeValid = bc_ok, BarcodeTotal = bc_total, PercentValid = bc_percent, PercentIgnored = ig_percent))
}
