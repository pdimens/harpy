...
```
This report summarizes the file: `r snakemake@input[[1]]`
## General Information
This reflects the general information stored in the records of the variant call file.
...
These statistics correspond to the `r sn$Number[1]` samples in the variant call file.
...
ggplotly(pscplot)
DT::datatable(psc, rownames = F, filter = "top", extensions = 'Buttons', options = list(dom = 'Brtip', buttons = c('csv', 'pdf')))
```
