...
- if created with [!badge corners="pill" text="harpy template groupings"](template.md/#groupings), all the samples will be assigned to group `pop1`, so make sure to edit the second column to reflect your data correctly.
