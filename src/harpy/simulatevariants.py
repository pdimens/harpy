...
@click.option('-p', '--prefix', type = str, default= "snpindel", show_default=True, help = "Naming prefix for output files")
...
@click.option('-e', '--exclude-chr', type = click.Path(exists=True), help = "Text file of chromosomes to avoid")
@click.option('--randomseed', type = click.IntRange(min = 1), help = "Random seed for simulation")
@click.option('-p', '--prefix', type = str, default= "inversion", show_default=True, help = "Naming prefix for output files")
@click.option('-s', '--snakemake', type = str, metavar = "String", help = 'Additional Snakemake parameters, in quotes')
@click.option('-q', '--quiet',  is_flag = True, show_default = True, default = False, metavar = "Toggle", help = 'Don\'t show output text while running')
@click.option('--print-only',  is_flag = True, hidden = True, show_default = True, default = False, metavar = "Toggle", help = 'Print the generated snakemake command and exit')
...
@click.option('-e', '--exclude-chr', type = click.Path(exists=True), help = "Text file of chromosomes to avoid")
@click.option('--randomseed', type = click.IntRange(min = 1), help = "Random seed for simulation")
@click.option('-p', '--prefix', type = str, default= "cnv", show_default=True, help = "Naming prefix for output files")
@click.option('-s', '--snakemake', type = str, metavar = "String", help = 'Additional Snakemake parameters, in quotes')
@click.option('-q', '--quiet',  is_flag = True, show_default = True, default = False, metavar = "Toggle", help = 'Don\'t show output text while running')
@click.option('--print-only',  is_flag = True, hidden = True, show_default = True, default = False, metavar = "Toggle", help = 'Print the generated snakemake command and exit')
...
@click.option('-e', '--exclude-chr', type = click.Path(exists=True), help = "Text file of chromosomes to avoid")
@click.option('--randomseed', type = click.IntRange(min = 1), help = "Random seed for simulation")
@click.option('-p', '--prefix', type = str, default= "translocation", show_default=True, help = "Naming prefix for output files")
@click.option('-s', '--snakemake', type = str, metavar = "String", help = 'Additional Snakemake parameters, in quotes')
@click.option('-q', '--quiet',  is_flag = True, show_default = True, default = False, metavar = "Toggle", help = 'Don\'t show output text while running')
@click.option('--print-only',  is_flag = True, hidden = True, show_default = True, default = False, metavar = "Toggle", help = 'Print the generated snakemake command and exit')
