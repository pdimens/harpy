...
def fastq(input, output_dir, threads, snakemake, quiet, print_only):
    ...
    command = f'snakemake --rerun-incomplete --rerun-triggers input mtime params --nolock --software-deployment-method apptainer --conda-prefix ./.snakemake/conda --cores {threads} --directory .'.split()
