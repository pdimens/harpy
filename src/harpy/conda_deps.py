...
def generate_conda_deps():
    ...
    environ = {
        ...
        "r" : ["conda-forge::r-xml2", "conda-forge::r-highcharter", "r::r-biocircos", "conda-forge::r-dt", "conda-forge::r-flexdashboard", "conda-forge::r-ggplot2", "conda-forge::r-plotly", "conda-forge::r-tidyr"],
