...
process_input <- function(infile){
  ...
  tot_uniq_bx <- system2(paste("zcat",infile, "| tail -1"), stdout = TRUE)
...
group of longest molecules that together represent **50%** of the total molecules by length. Below is the distribution of
three common NX metrics (N50, N75, N90) across all samples.
...
```{r mol_per_contig, echo = F, warning = F, message = F}
