...
valids %>% 
    ...
    DT::datatable(rownames = F, options = list(dom = 'Brtip', buttons = list(list(extend = "csv",filename = paste0(samplename ,"_molecule_NX")))), fillContainer = T)
```
...
DT::datatable(
  ...
  rownames = F, 
  extensions = 'Buttons', 
  options = list(dom = 'Brtip', buttons = list(list(extend = "csv",filename = paste0(samplename ,"_align_depth_avg"))), scrollX = TRUE), 
...
DT::datatable(
  ...
  rownames = F, 
  extensions = 'Buttons', 
  options = list(dom = 'Brtip', buttons = list(list(extend = "csv",filename = paste0(samplename ,"_align_depth_filt_avg"))), scrollX = TRUE),
  colnames = c('Contig', 'Average Depth', 'Standard Deviation'),
  autoHideNavigation = T,
  fillContainer = T,
  height = "fit-content"
...
DT::datatable(
  ...
  rownames = F, 
  extensions = 'Buttons', 
  options = list(dom = 'Brtip', buttons = list(list(extend = "csv",filename = paste0(samplename ,"_align_depth_outlier_avg")))), scrollX = TRUE),
