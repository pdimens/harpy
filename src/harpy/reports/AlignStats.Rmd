...
totuniqBX <- system2(paste("zcat",snakemake@input[[1]], "| tail -1"), stdout = TRUE)
...
```bash
samtools depth -a <input.bam> | depthWindows.py <windowsize>
```

This plot allows you to hover regions to view their coverage, pan by clicking and dragging,
