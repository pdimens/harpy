...
output:
  flexdashboard::flex_dashboard:
    ...
    logo: https://raw.githubusercontent.com/pdimens/harpy/docs/static/navbarlogo.svg
...
```{r echo = FALSE, message = FALSE, warning = FALSE, fig.height=figheight, out.width = '100%'}
tb<-plotdata %>%
