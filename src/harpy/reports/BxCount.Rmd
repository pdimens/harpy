...
hchart(inv_hist, "areaspline", hcaes(x = Bin, y = Count, group = Segment), stack = "overlap", marker = list(symbol = "circle")) |>
...
The plot below categorizes which barcode segments are invalid, which may help troubleshoot
sample prepartion.
