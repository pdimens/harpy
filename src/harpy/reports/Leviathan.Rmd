...
This should help you assess the presence/absence of expected variants. There are 4 "rings" in this plot, each corresponding
to a type of structural variant (inversions in the outer ring, then deletions, etc.). All four rings
are going to be shown, even if there are not variants of that type.  Refer to the legend on the bottom right, which is
labelled by color and ordered by corresponding ring.
...
# add the "legend"
tracks = tracks + BioCircosTextTrack("InvText", "Inversion", size = "1.5em", x = 1.4,  y = 0.8, color = "#4a9fea")
tracks = tracks + BioCircosTextTrack("DupText", "Duplication", size = "1.5em", x = 1.4,  y = 0.6, color = "#ffd75f")
tracks = tracks + BioCircosTextTrack("DelText", "Deletion", size = "1.5em", x = 1.4,  y = 0.4, color = "#5a8c84")
tracks = tracks + BioCircosTextTrack("BndText", "Breakend", size = "1.5em", x = 1.4,  y = 0.2, color = "#df487f")
...
BioCircos(
  ...
  ARCMouseOverColor = "#f76808", ARCMouseOverArcOpacity = 1.0,
  genomeLabelDy = 0,
  width = "100%"
)
```