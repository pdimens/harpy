...
if(do_qual){
  hchart(mergebins(qual[,-3]), "areaspline", hcaes(x = QualityScore, y = SNPs), color = "#8fbbbc", name = "count") |>
...
if(do_qual){
  hchart(mergebins(qual[,-2]), "areaspline", hcaes(x = QualityScore, y = Indels), name = "count", color = "#9393d2") |>
...
if(sum(.dpL) == 0){
  ...
  hchart(dp, "areaspline", hcaes(x = Bin, y = NumberSites), name = "count", color = "#F28500") |>
...
if(sum(.iddL) == 0){
  ...
  hchart(idd, "areaspline", hcaes(x = Length, y = Count, group = Type)) |>
