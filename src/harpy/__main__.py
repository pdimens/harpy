...
click.rich_click.OPTION_GROUPS = {
    ...
    "harpy align ema": [
        {
            "name": "Configuration",
            "options": ["barcode", "--whitelist", "--genome", "--directory", "--quality-filter", "--molecule-distance", "--ema-bins", "--extra-params"],
        },
        {
            "name": "Other Options",
            "options": ["--threads", "--snakemake", "--quiet", "--help"],
    ...
    "harpy sv naibr": [
        {
            "name": "Configuration",
            "options": ["--genome", "--directory", "--vcf", "--molecule-distance", "--populations", "--extra-params"],
        },
        {
            "name": "Other Options",
            "options": ["--threads", "--snakemake", "--quiet", "--help"],
