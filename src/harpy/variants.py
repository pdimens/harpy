...
@click.option('-m', '--method', default = "mpileup", show_default = True, type = click.Choice(["mpileup", "freebayes"], case_sensitive = False), metavar = "String", help = "Method for calling variants")
...
def snp(genome, threads, directory, populations, ploidy, method,windowsize, extra_params, snakemake, quiet):
    """
