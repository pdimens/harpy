...
@click.option('-o', '--output', required = True, type=click.Path(exists=True), metavar = "Output file", help = 'Name of output file')
@click.option('-s', '--system', required = True, type = click.Choice(["slurm", "sge"], case_sensitive = False), help = 'HPC scheduling system [slurm, sge]')
