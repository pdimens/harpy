...
### check_bam.py
```bash
check_bam.py platform input.bam > output.txt
```
...
### check_fastq.py
```bash
check_fastq.py platform input.fq > output.txt
```
...
### inline_to_haplotag.py [!badge variant="warning" corners="pill" text="deprecated"]
```bash
...
### leviathan_bx_shim.py [!badge variant="warning" corners="pill" text="deprecated"]
```bash
...
### standardize_barcodes_sam.py
```bash
standardize_barcodes_sam.py input.bam > output.sam
```
